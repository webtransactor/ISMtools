...
[source,shell,indent=8]
----
$ ism_show_env -i 10.10.10.100
2022-12-23 11:44:51 -- Effective settings:
                        ISM_VA:       10.10.10.100:25566
                        ISM_FQDN:     ism.test.com.
                        ISM_IP:       10.10.10.100
...
$ ism_chk_con -i 10.10.10.100 -u administrator:wrongPW
...
----
$ ism_cmd GET /nodes <1>
{"MessageInfo":[],"SchemaType":"https://10.10.10.100:25566/ism/schema/v2/Nodes/Nodes-GET-Out.0.0.1.json","IsmBody":{"Nodes":[{"AdditionalData":{},"Fabric":[],"ParentFabricId":null,"DataCenterInfo":{"DcId":null,"Name":null},"SlotNum":null,"UpdateDate":"2022-12-23T06:44:41.931Z","ChildNodeList":[],"IpAddress":"10.10.124.85","Model":"PRIMERGY RX100 S8","Status":"Normal","Description":null,"AlarmStatus":"Warning","Type":"server","NodeGroupId":8,"NodeTagList":[],"IpVersion":"V4"
... (truncated)
----
...
{
  "MessageInfo": [],
  "SchemaType": "https://10.10.125.85:25566/ism/schema/v2/Nodes/NodesInventory-GET-Out.0.0.1.json",
  "IsmBody": {
    "Nodes": [
      {
        "Manufacture": "FUJITSU",
...
{
  "SchemaType": "https://10.10.125.85:25566/ism/schema/v2/Event/EventHistoryEventShow-GET-Out.0.0.1.json",
  "MessageInfo": [],
  "IsmBody": {
    "Logs": [
      {
...
{
  "MessageInfo": [],
  "SchemaType": "https://10.10.125.85:25566/ism/schema/v2/Nodes/Nodes-GET-Out.0.0.1.json",
  "IsmBody": {
    "Nodes": [
      {
        "AdditionalData": {},
...
{
  "MessageInfo": [],
  "SchemaType": "https://10.10.125.85:25566/ism/schema/v2/Event/EventHistoryTrap-GET-Out.0.0.1.json",
  "IsmBody": {
    "TrapLogs": [
      {
        "TrapLogId": "3252753",
        "TrapMessage": "Received from 10.10.126.150. Authentication failure: Unauthorized message received.",
        "ResourceType": "Node",
...
"sep=,"
"UniqInfo","IpAddress"
"MACK001036","10.10.124.101"
"EWAL001056","10.10.124.113"
"YLNS001039","10.10.124.125"
"YM6D024205","10.10.124.233"
"YLVT001989","10.10.124.87"
"YMSQ002118","10.10.124.225"
"YM6D009446","10.10.124.145"
"YLNV001022","10.10.124.203"
"YMTJ001026","10.10.124.221"
"YM6D024204","10.10.124.231"
----
...
2023-01-05 10:16:59 --    ZIP file=https://10.10.125.85:25566/ism/data/export/Administrator/transfer/Archive/fc045d8db0565cb83f8e1f649202cab7/download/archivedlog/397/ArchivedLog_20230105101654.zip
...
PRIMERGY RX2540 M6;REST-Demo1;Added by script;10.10.124.223;admin;admin;9;36;2;REST-API Testserver JO
PRIMERGY RX4770 M4;REST-Demo2;Added by script;10.10.124.247;admin;admin;9;38;2;REST-API Testserver JO
PRIMERGY RX2530 M1;REST-Demo3;Added by script;10.10.124.147;admin;admin;9;40;1;REST-API Testserver JO

$ ism_add_server ism_nodes.csv
2023-01-05 17:18:20 -- Registering node 10.10.124.223 ... OK
2023-01-05 17:18:29 -- BG-Retrieving information from NodeID 10290 ... PID=2635
-------------------------------------------------------------------------------
2023-01-05 17:18:30 -- Registering node 10.10.124.247 ... OK
2023-01-05 17:18:38 -- BG-Retrieving information from NodeID 10291 ... PID=2671
-------------------------------------------------------------------------------
2023-01-05 17:18:39 -- Registering node 10.10.124.147 ... OK
...
2023-01-05 10:29:44 -- BG refreshing NodeId 10177 (10.10.124.101) [PID=2264]
2023-01-05 10:29:44 -- BG refreshing NodeId 10180 (10.10.124.113) [PID=2266]
2023-01-05 10:29:44 -- BG refreshing NodeId 10181 (10.10.124.125) [PID=2269]
2023-01-05 10:29:45 -- BG refreshing NodeId 10118 (10.10.124.233) [PID=2274]
2023-01-05 10:29:45 -- BG refreshing NodeId 10157 (10.10.124.87) [PID=2280]
2023-01-05 10:29:45 -- BG refreshing NodeId 10191 (10.10.124.225) [PID=2286]
2023-01-05 10:29:46 -- BG refreshing NodeId 10192 (10.10.124.145) [PID=2293]
2023-01-05 10:29:47 -- BG refreshing NodeId 10230 (10.10.124.203) [PID=2301]
2023-01-05 10:29:47 -- BG refreshing NodeId 10143 (10.10.124.221) [PID=2306]
2023-01-05 10:29:48 -- BG refreshing NodeId 10117 (10.10.124.231) [PID=2313]
----
...
{
  "SchemaType": "https://10.10.125.85:25566/ism/schema/v2/System/SystemSettingsFirmwareFtsFirmwareDownload-POST-Out.0.0.1.json",
  "MessageInfo": [],
  "IsmBody": {
    "TaskId": "398",
    "CancelUri": "https://10.10.125.85:25566/ism/api/v2/system/settings/firmware/ftsfirmware/download/cancel"
  }
}
