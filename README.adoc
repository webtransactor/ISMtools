...
|1.0.16|2025-07-24|* New command `ism_get_power_consumption` to get overview about power consumption of all server nodes (thanks to mailto:michael.ahn@fujitsu.com[Michael Ahn])|mailto:{email2}[{maintainer}]
...
Gets overview about power consumption of all server nodes.
