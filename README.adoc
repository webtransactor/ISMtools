...
:imagesdir: https://raw.githubusercontent.com/fujitsu/ISMtools/main/img/
endif::[]
= ISMtools {version}
...
|1|2023-01-13|Initial version with a set of about 20 scripts|mailto:{email}[{Author}]
|=================
...
* <<ism_list_events>> +
List all events for a given node.

* <<ism_list_nodes>> +
List all node information in formatted JSON format.

* <<ism_list_traps>> +
List all traps for given node.
...
* <<ism_get_rackid>> +
Displays the _RackId of given rack name.
...
#!/bin/bash
# (c) Juergen Orth ;-)
# $Id: .ism_env 159 2022-12-19 08:39:48Z HMBJOrth $
...
ISM_VA_DEFAULT=ism.customer.net:25566
...
image::REST_example_from_spec.png[REST: Example from REST API reference]
...
image::3Dview.png[REST: Example for new servers added by REST API]
